...
local ThemeManager = {} do
	ThemeManager.Folder = 'XecretHub/ThemeManager'
	...
	ThemeManager.BuiltInThemes = {
		Default = {
			1,
			httpService:JSONDecode("{\"FontColor\":\"f5f5f5\",\"MainColor\":\"1f1f1f\",\"AccentColor\":\"ff6b00\",\"BackgroundColor\":\"141414\",\"OutlineColor\":\"2a2a2a\"}")
		},
		["Azure Drift"] = {
			2,
			httpService:JSONDecode("{\"FontColor\":\"f5f5f5\",\"MainColor\":\"1f1f1f\",\"AccentColor\":\"00bfff\",\"BackgroundColor\":\"121212\",\"OutlineColor\":\"2a2a2a\"}")
		},
		["Obsidian Void"] = {
			3,
			httpService:JSONDecode("{\"FontColor\":\"f5f5f5\",\"MainColor\":\"1f1f1f\",\"AccentColor\":\"000000\",\"BackgroundColor\":\"141514\",\"OutlineColor\":\"2a2a2a\"}")
		},
		["Amethyst Core"] = {
			4,
		...
		["Dark Crimson"] = {
			10,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a0f0f\",\"AccentColor\":\"ff3333\",\"BackgroundColor\":\"0f0606\",\"OutlineColor\":\"2a1a1a\"}")
		},
		["Haze Violet"] = {
			11,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a1226\",\"AccentColor\":\"8a2be2\",\"BackgroundColor\":\"100b1a\",\"OutlineColor\":\"2e2240\"}")
		},
		["Ocean Depth"] = {
			12,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1419\",\"AccentColor\":\"00bfff\",\"BackgroundColor\":\"050a0f\",\"OutlineColor\":\"1f2933\"}")
		},
		["Forest Echo"] = {
			13,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0d1b0d\",\"AccentColor\":\"32cd32\",\"BackgroundColor\":\"061006\",\"OutlineColor\":\"1a2b1a\"}")
		},
		["Sunset Ember"] = {
			14,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1f1710\",\"AccentColor\":\"ff6347\",\"BackgroundColor\":\"120e08\",\"OutlineColor\":\"2f2520\"}")
		},
		["Golden Age"] = {
			15,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a1a1a\",\"AccentColor\":\"ffd700\",\"BackgroundColor\":\"0d0d0d\",\"OutlineColor\":\"2a2a2a\"}")
		},
		["Blood Eclipse"] = {
			16,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a0f0f\",\"AccentColor\":\"dc143c\",\"BackgroundColor\":\"0a0505\",\"OutlineColor\":\"3d1a1a\"}")
		},
		["Neon Surge"] = {
			17,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1a1a\",\"AccentColor\":\"00ffff\",\"BackgroundColor\":\"050f0f\",\"OutlineColor\":\"1a3d3d\"}")
		},
		["Royal Veil"] = {
			18,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a0f1a\",\"AccentColor\":\"9370db\",\"BackgroundColor\":\"0f050f\",\"OutlineColor\":\"3d1a3d\"}")
		},
		["Pink Voltage"] = {
			19,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a0f1a\",\"AccentColor\":\"ff1493\",\"BackgroundColor\":\"0f050f\",\"OutlineColor\":\"3d1a3d\"}")
		},
		["Ice Shard"] = {
			20,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1a1f\",\"AccentColor\":\"87ceeb\",\"BackgroundColor\":\"050f12\",\"OutlineColor\":\"1a3d4d\"}")
		},
		["Lava Core"] = {
			21,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1f0f0a\",\"AccentColor\":\"ff4500\",\"BackgroundColor\":\"120805\",\"OutlineColor\":\"4d1a0a\"}")
		},
		["Midnight Realm"] = {
			22,
			httpService:JSONDecode("{\"FontColor\":\"c0c0c0\",\"MainColor\":\"050505\",\"AccentColor\":\"4169e1\",\"BackgroundColor\":\"000000\",\"OutlineColor\":\"1a1a1a\"}")
		},
		["Toxic Bloom"] = {
			23,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a1f0f\",\"AccentColor\":\"adff2f\",\"BackgroundColor\":\"0f1205\",\"OutlineColor\":\"3d4d1a\"}")
		},
		["Magenta Storm"] = {
			24,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1f0f1f\",\"AccentColor\":\"ff00ff\",\"BackgroundColor\":\"120512\",\"OutlineColor\":\"4d1a4d\"}")
		},
		["Turquoise Mist"] = {
			25,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1f1a\",\"AccentColor\":\"40e0d0\",\"BackgroundColor\":\"051208\",\"OutlineColor\":\"1a4d3d\"}")
		},
		Aurora = {
			26,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1a1a2e\",\"AccentColor\":\"00ffff\",\"BackgroundColor\":\"0f0f1f\",\"OutlineColor\":\"2a2a4d\"}")
		},
		Vaporwave = {
			27,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"2a1f4d\",\"AccentColor\":\"ff77ff\",\"BackgroundColor\":\"1a0f2f\",\"OutlineColor\":\"4d3d7a\"}")
		},
		["Steel Core"] = {
			28,
			httpService:JSONDecode("{\"FontColor\":\"dcdcdc\",\"MainColor\":\"2f2f2f\",\"AccentColor\":\"808080\",\"BackgroundColor\":\"1a1a1a\",\"OutlineColor\":\"3d3d3d\"}")
		},
		Galaxy = {
			29,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0b0b2b\",\"AccentColor\":\"8a2be2\",\"BackgroundColor\":\"050517\",\"OutlineColor\":\"1f1f4d\"}")
		},
		["Emerald Dream"] = {
			30,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1f0f\",\"AccentColor\":\"50fa7b\",\"BackgroundColor\":\"051205\",\"OutlineColor\":\"1a3d1a\"}")
		},
		["Shadow Realm"] = {
			31,
			httpService:JSONDecode("{\"FontColor\":\"c0c0c0\",\"MainColor\":\"0a0a0a\",\"AccentColor\":\"4b0082\",\"BackgroundColor\":\"000000\",\"OutlineColor\":\"1a1a1a\"}")
		},
		Inferno = {
			32,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"2b0f0f\",\"AccentColor\":\"ff4500\",\"BackgroundColor\":\"1a0505\",\"OutlineColor\":\"4d1a1a\"}")
		},
		["Mystic Forest"] = {
			33,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"0f1a0f\",\"AccentColor\":\"228b22\",\"BackgroundColor\":\"050f05\",\"OutlineColor\":\"1a3d1a\"}")
		},
		Twilight = {
			34,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"2c2c54\",\"AccentColor\":\"706fd3\",\"BackgroundColor\":\"1a1a2e\",\"OutlineColor\":\"3d3d6d\"}")
		},
		["Neon Sunset"] = {
			35,
			httpService:JSONDecode("{\"FontColor\":\"ffffff\",\"MainColor\":\"1f0f1f\",\"AccentColor\":\"ff4500\",\"BackgroundColor\":\"120812\",\"OutlineColor\":\"4d1a1a\"}")
		}
	};
